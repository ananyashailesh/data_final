"""
Clean and organize Shopbop bag data
"""
import csv
import re

INPUT_FILE = "bag_shopbop.csv"
...
def extract_brand_from_product_name(product_name, fallback_brand):
    ...
    # Check for luxury brands in product name
    for brand in LUXURY_BRANDS:
        if brand.lower() in product_name.lower():
            return brand
    
    # If no luxury brand found, return the first word(s) as brand guess
    return fallback_brand
